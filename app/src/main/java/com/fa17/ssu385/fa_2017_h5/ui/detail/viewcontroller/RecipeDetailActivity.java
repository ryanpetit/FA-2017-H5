...
public class RecipeDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipeDetailName = findViewById(R.id.recipe_detail_name);
        recipeDescription = findViewById(R.id.recipe_description);
        recipeDetailImage = findViewById(R.id.recipe_detail_image);

        Recipe recipe = Parcels.unwrap(getIntent().getParcelableExtra(RECIPE_EXTRA_KEY));

        recipeDetailName.setText(recipeDetailName.getText());
        recipeDescription.setText(recipeDescription.getText());
