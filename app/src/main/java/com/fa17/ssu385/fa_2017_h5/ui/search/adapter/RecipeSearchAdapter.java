...
public class RecipeSearchAdapter extends RecyclerView.Adapter<RecipeItemViewHolder> implements RecipeItemViewHolder.OnItemClickedListener {
    ...
    private RecipeItemViewHolder.OnItemClickedListener onItemClickedListener;
    ...
    public void onBindViewHolder(RecipeItemViewHolder holder, int position) {
        ...
        holder.setListener(onItemClickedListener);
